...
// function contentLight(id) {
// var parent = document.body.children[4];
// alert(parent);
// $(id).style.backgroundColor="#000099";
// }

function openSpoiler1(id) {$(id).children[2].style.display = "block";
$(id).children[1].innerText = " . . . скрыть";}
...
function spoiler1(a) {
    if (a.parentNode.getElementsByTagName("div")[0].style.display == "none") {
...
var type_void = "тип значения <tt>void</tt>, т.е. у функции нет возвращаемого значения<br>или возвращается пустой список параметров (void - пустой)"
var type_string = "тип значения <tt>string</tt> - строка"
var type_this = "значением должен быть вызывающий объект"
var type_float = "тип значения <tt>float</tt> - число<br>с плавающей запятой"
var type_int = "тип значения <tt>integer</tt> - целое число"
var type_number = "тип значения <tt>number</tt> - число"
var type_array = "тип значения <tt>array</tt> - массив"
var type_typearray = "тип значения <tt>TypedArray</tt><br>(типизированный массив)"
var type_bool = "тип значения <tt>boolean</tt> - логический тип<br>(либо <tt>true</tt>, либо <tt>false</tt>)"
var type_func = "тип значения <tt>function</tt> - т.е. значением<br>аргумента должна быть функция"
var type_null = "тип значения <tt>null</tt> - т.е.<br>значение неизвестно"
var type_obj = "тип значения <tt>object</tt> - т.е.<br>аргумент является объектом"
...
var note_0 = '<div class=list><tt>parameters</tt> - объект с одним или несколькими свойствами, определяющими внешний вид материала (дополнительный, необязательный параметр). Здесь можно передать любое свойство материала (включая любое свойство унаследованное от <a href="material.htm" onmouseover="show(\'Material\')" onmouseout="hide()">Material</a>).</div>'
var note_01 = 'Исключением является свойство <tt><span onclick="showClick(type_hex)"><a href="#" onclick="return false" onblur="hideClick()" onmouseover="show(\'Color.<br>color - цвет\')" onmouseout="hide()">color</a></span></tt>, значение которого можно передать как шестнадцатиричную строку и по умолчанию равно <tt>0xffffff</tt> (белый цвет). Метод <tt><a href="../math/color.htm#set" onmouseover="show(\'Color.set\')" onmouseout="hide()">Color.set( color )</a></tt> вызывается внутренне.'
var note_1 = 'Данное свойство соответствует свойству <a href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineJoin" target="_blank"><tt>lineJoin</tt> в 2D Canvas</a> и игнорируется <a href="../renderers/webGLRenderer.htm" onmouseover="show(\'WebGLRenderer\')" onmouseout="hide()">WebGL</a> визуализатором (рендерером). Вот эта <a href="https://developer.mozilla.org/ru/docs/Web/API/CanvasRenderingContext2D/lineJoin" target="_blank">статья о <tt>lineJoin</tt></a> на русском языке.'
var note_3 = '<br>Из-за ограничений в <a href="https://code.google.com/p/angleproject" target="_blank">слое ANGLE</a> с визуализатором (рендерером) <a href="../renderers/webGLRenderer.htm" onmouseover="show(\'WebGLRenderer\')" onmouseout="hide()">WebGL</a> в операционных системах на основе Windows толщина линии (т.е. значение параметра <tt>linewidth</tt>) всегда будет равна <tt>1</tt>, независимо от установленного значения.'
